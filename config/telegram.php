...
use App\Bot\Commands\CancelCommand;
use App\Bot\Commands\SavedRecipeCommand;
use App\Bot\Commands\SearchRecipeCommand;
use App\Bot\Commands\StartCommand;
use App\Bot\Commands\ViewRecipeCommand;
use App\Bot\Commands\RandomRecipeCommand;
    ...
    */
    'ran' => [
        'commands' => [
            ...
            '/search_recipe' => SearchRecipeCommand::class,
            '/saved_recipe' => SavedRecipeCommand::class,
            '/random_recipe' => RandomRecipeCommand::class,
        ],

        'default_command' => '/start',

        'direct_commands' => [
            '/cancel_command' => [CancelCommand::class, 'handle'],
            'viewrecipe' => [ViewRecipeCommand::class, 'handle'],
            'savedrecipe_store' => [SavedRecipeCommand::class, 'store'],
            'savedrecipe_delete' => [SavedRecipeCommand::class, 'delete'],
        ],
    ],
